 ...
 */
        ...
        (function (window, document, undefined) {
          ...
          var ua = navigator.userAgent;
          var supportAbort = (/rident/).test(ua) ||
            ...
            function parseDescriptors() {
              ...
              for (i = 0; i < descriptors.length; i++) {
                ...
                if (regexNonNegativeInteger.test(value) && (lastChar === "w")) {
                  ...
                  regexFloatingPoint.test(value) && (lastChar === "x")
                ) {
                  ...
                  regexNonNegativeInteger.test(value) && (lastChar === "h")
                ) {
          ...
          pf.applySetCandidate = function (candidates, img) {
            ...
            if (curCan && curCan.set === candidates[0].set) {
              ...
              abortCurSrc = supportAbort && !img.complete &&
                curCan.res - 0.1 > dpr;
          ...
          pf.getSet = function (img) {
            ...
            for (i = 0; i < sets.length && !match; i++) {
              ...
              if (
                !set.srcset || !pf.matchesMedia(set.media) ||
          ...
          pf.parseSets = function (element, parent, options) {
            ...
            var hasPicture = parent &&
              parent.nodeName.toUpperCase() === "PICTURE";
            ...
            if (
              imageData.srcset === undefined || options.srcset ||
              !pf.supSrcset || element.srcset
            ) {
            ...
            if (imageData.srcset) {
              ...
              if (
                !isWDescripor && imageData.src &&
                !getCandidateForSrc(imageData.src, imageSet) && !imageSet.has1x
              ) {
            ...
            imageData.supported =
              !(hasPicture || (imageSet && !pf.supSrcset) ||
            ...
            if (
              imageData.supported && !imageData.srcset &&
