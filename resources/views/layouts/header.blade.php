<header class="header tm-header-toparea">
    <div class="container">
        <div class="row align-items-center justify-content-start">
            ...
            @endif
            <div class="header-add-company text-center"><a href="#">Добавить компанию</a></div>
        </div>
    </div>
</header>
