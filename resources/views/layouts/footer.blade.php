      ...
      <div class="container">
          <div class="footer__inner flex-btw">
              <button class="footer__btn-top">
                  <img class="footer__btn-img" src="img/icon/arrow-square-down.svg" alt="" />
              </button>
              <a class="footer__logo" href="#">
                  <img src="img/logo-footer.svg" alt="RentSell logo" />
              </a>
